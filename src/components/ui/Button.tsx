...
export default function Button({
  ...
  return (
    <button
      className={`
        inline-flex items-center cursor-pointer justify-center gap-2 px-3 py-2 text-sm font-medium rounded-btn transition focus:ring-brand-300 focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed
